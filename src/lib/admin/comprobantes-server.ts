...
export function validarComprobante(
  ...
  const importes = {
    ...
    percepcionIibbBsas: importe(raw.percepcionIibbBsas),
    percepcionIibbCaba: importe(raw.percepcionIibbCaba),
  ...
  const fila: Fila = {
    ...
    percepcion_iibb_bsas: importes.percepcionIibbBsas,
    percepcion_iibb_caba: importes.percepcionIibbCaba,
